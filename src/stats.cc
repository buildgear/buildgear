...
void CStats::saveCapture(string filename)
{
   ...
   this->svg.addText("MEM usage [%]", 0, 0, "black",
         "text-anchor='middle' font-size='7' transform='rotate(-90)'");
   this->svg.addNaked("</g>");
   this->svg.addRectangle(LOAD_CHART_MARGIN + 1.5 * LOAD_CHART_LINE_HEIGHT - 1,
