...
#define FOOTPRINT_NATIVE_DIR     BUILD_FILES_DIR "/.footprint/native"
#define FOOTPRINT_CROSS_DIR      BUILD_FILES_DIR "/.footprint/cross"
#define CHECKSUM_NATIVE_DIR      BUILD_FILES_DIR "/.checksum/native"
#define CHECKSUM_CROSS_DIR       BUILD_FILES_DIR "/.checksum/cross"
